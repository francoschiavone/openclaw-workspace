...
exports.huntDomainsTool = exports.huntDomainsSchema = void 0;
exports.executeHuntDomains = executeHuntDomains;
const zod_1 = require("zod");
const domain_hunter_js_1 = require("../services/domain-hunter.js");
const errors_js_1 = require("../utils/errors.js");
const logger_js_1 = require("../utils/logger.js");
/**
 * Input schema for hunt_domains.
 */
exports.huntDomainsSchema = zod_1.z.object({
    keywords: zod_1.z
        .array(zod_1.z.string())
        .optional()
        .describe("Keywords to search for. Used to match existing domains and generate brandable patterns. " +
    ...
    include_aftermarket: zod_1.z
        .boolean()
        .optional()
        .default(true)
        .describe("Include Sedo auction listings. Defaults to true."),
    max_aftermarket_price: zod_1.z
        .coerce
        .number()
        .min(1)
        .optional()
    ...
    patterns: zod_1.z
        .array(zod_1.z.enum(['short', 'dictionary', 'numeric', 'brandable', 'acronym']))
        .optional()
        .default(['short', 'brandable'])
        .describe("Pattern types to generate. Options: 'short' (3-5 chars), 'dictionary' (common words), " +
 ...
 */
async function executeHuntDomains(input) {
    try {
        const validated = exports.huntDomainsSchema.parse(input);
        logger_js_1.logger.info('Hunting domains', {
            keywords: validated.keywords,
            patterns: validated.patterns,
            tlds: validated.tlds,
        });
        // Execute the hunt
        const huntResult = await (0, domain_hunter_js_1.huntDomains)({
            keywords: validated.keywords,
            tlds: validated.tlds,
...
//# sourceMappingURL=hunt_domains.js.map